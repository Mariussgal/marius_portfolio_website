...
export default function OpenZeppelin() {
    return (
        ...
        >
            ...
            <g>
                <g>
                    <path fill="#1D1D1B" d="M151.6,234.6v-16.9h-18.2c-4.9,0-9.5,2.6-12.1,6.9l-5.9,10H151.6z" />
                    <path fill="#1D1D1B" d="M93.7,169.5v16.9h47.9l10-16.9H93.7z" />
                    <path fill="#1D1D1B" d="M117.3,196.3l-23.5,38.3h20.1l28.2-45.8h-11.1C125.3,188.8,120.1,191.7,117.3,196.3z" />
                    <path fill="#1D1D1B" d="M192.7,219.7c-9.8,0-17-7.2-17-17c0-9.6,7.3-17,17.1-17c9.8,0,17.1,7.4,17.1,17
