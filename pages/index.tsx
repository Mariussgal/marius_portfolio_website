...
const recentProjects = [
  {
    ...
    date: 'Jun 2026',
    href: 'https://ethglobal.com/showcase/echo-sh56g',
  },
  {
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Marius Gal — Engineering student passionate about blockchain and DeFi. Explore my projects, smart contracts, and NFT business card." />
        ...
        <div className="w-full px-8 md:px-16 pt-8 pb-6 flex-shrink-0 z-10 bg-white border-b border-[#E5E9F2]">
          <div className="flex items-center justify-between mb-3">
            <div className="flex flex-col">
              ...
              <p className="font-mono text-[12px] text-[#4B65FF] font-semibold tracking-widest uppercase mt-1">Engineering Student</p>
            </div>
          </div>
