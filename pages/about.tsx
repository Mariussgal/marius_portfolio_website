...
const About: NextPage = () => (
  <>
    <Head>
      ...
      <meta name="description" content="Passionate about Blockchain technology and DeFi, take a look to my recent projects" />
      ...
      <div className="w-full px-8 md:px-16 pt-8 pb-6 flex-shrink-0 z-10 bg-white border-b border-[#E5E9F2]">
        <div className="flex items-center gap-6">
          ...
          <div className="flex flex-col">
            ...
            <p className="font-mono text-[12px] text-[#4B65FF] font-semibold tracking-widest uppercase mt-2">Engineering student</p>
          </div>
        </div>
      </div>
